...
print("Now plotting sites with one sandbar with bathymetry")
#Set working directry
setwd("C:/workspace/sandbar_process/plotting_out/")

#get list of folders in the Script_Out directory
foldernames <- list.files(path="C:/workspace/sandbar_process/csv_output/CSVs")
...
for(i in foldernames){
  ...
  filepath <- file.path("C:/workspace/sandbar_process/csv_output/CSVs",paste(i)) 
